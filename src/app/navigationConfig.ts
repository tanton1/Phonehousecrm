...
export const NAVIGATION_GROUPS: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: "crm",
        label: "Pipeline Lead CRM",
        icon: Users,
        shortcut: "Alt+4",
        permission: "CRM_READ",
      },
      {
        id: "quick-quote-requests",
        label: "Báo giá miniweb",
        icon: ClipboardList,
        roles: [
          "ADMIN",
          "REGIONAL_MANAGER",
      ...
      {
        id: "customer-service-requests",
        label: "Yêu cầu sửa từ khách",
        icon: Wrench,
        roles: [
          "ADMIN",
          "REGIONAL_MANAGER",
    ...
    items: [
      {
        ...
        label: "Sửa chữa lẻ",
        icon: Wrench,
        roles: ["ADMIN", "MANAGER", "ACCOUNTANT", "SALES", "SALE", "CASHIER"],
      },
      {
        id: "tech-workspace",
        label: "Bàn kỹ thuật & KCS",
        icon: Cpu,
        roles: ["ADMIN", "MANAGER", "TECH_LEAD", "TECH", "TECHNICIAN"],
      },
    ],
  },
  {
