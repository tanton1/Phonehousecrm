...
export type QuickQuoteDeviceOffer = { selectionToken: string; name: string; description?: string; model: string; storage: string; color: string; colors: string[]; condition: string; region: string; batteryHealth: number; warrantyPeriodMonths: number; imageUrl?: string | null; publicSortOrder?: number; branchId: string; branchName: string; availableBranchIds: string[]; availableBranchNames: string[]; price: number; priceIsStartingFrom?: boolean; inStock: true };
