...
export type CustomerPromotion = { id: string; title: string; summary: string; details: string; category: string; bannerUrl?: string | null; startsAt?: string | null; endsAt?: string | null; branchIds: string[]; allBranches: boolean; conditions: string[]; ctaLabel: string; ctaType: string; voucherCode?: string | null; personalized: boolean };
...
export type CustomerRequest = { id: string; type: string; model: string; imeiMasked: string; issueType: string; description: string; branchId: string; branchName: string; preferredVisitAt?: string | null; status: string; statusLabel: string; convertedWorkOrderId?: string | null; evidenceCount: number; createdAt?: string | null; updatedAt?: string | null };
